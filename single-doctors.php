...
if ($video_url):
	?>
    <section class="doctor-vbio-section" id="video">
        <div class="container">
...
if ($certificates):
	...
	?>
    <section class="doctor-certificates" id="certificates">
...
<section>
	<div class="container" id="appointment">
		<?php get_template_part('template-parts/forms/doctor-record', false, ['doctor' => $doctor, 'post_thumbnail' => $post_thumbnail]); ?>
    </div>
</section>

<?php get_template_part('templates/sections/videos'); ?>
...
<?php get_template_part('templates/sections/branch-addresses'); ?>
