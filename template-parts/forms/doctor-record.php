<div class="popup dent-form">
	<div class="dent-form__image">
		<img src="<?=$args['post_thumbnail']?>" width="400" height="300" alt="Запись к врачу <?=$args['doctor']['title']?>" loading="lazy">
	</div>
	<div class="dent-form__content">
		<h2 class="dent-form__title">Запишитесь на приём</h2>
		...
		<form class="dent-form__form">
			...
			<input type="hidden" name="title" value="Запись к врачу <?=$args['doctor']['title']?>">
		</form>
	</div>
</div>