<div class="popup dent-form">
	<div class="dent-form__image">
		<img src="<?=get_template_directory_uri()?>/assets/img/popup-promotion.jpg" width="400" height="300" alt="Заказать обратный звонок" loading="lazy">
	</div>
	<div class="dent-form__content">
		<h2 class="dent-form__title">Запишитесь со скидкой</h2>
